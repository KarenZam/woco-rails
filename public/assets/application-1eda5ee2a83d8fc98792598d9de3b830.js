...
//tooltip & quotes carousel speed  
   $('[data-toggle="tooltip"]').tooltip({ 'placement': 'top' })
	jQuery('.carousel2').carousel({ interval: 2500})
...
$(window).load(function(){
	$(".google-maps").gmap3({
    marker:{     
	address:"148 Wing Lok Street, Sheung Wan, Hong Kong",  options:{icon: "assets/marker.png"}},
    map:{
      options:{
styles: [ {
stylers: [ { "saturation":1 }, { "lightness": 100 },  { "hue": "#ffffff" } ]
},
...
(function() {
  $(function() {
    ...
    sendMessage = function() {
      var body, data, email, posting, subject;
...
(function() {
  $(function() {
    ...
    return $('#ajax-contact-form').on('submit', function(e) {
      e.preventDefault();
      return sendMessage();
    });
  });
